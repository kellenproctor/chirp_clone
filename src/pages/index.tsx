...
const Home: NextPage = () => {
  ...
  return (
    <>
      ...
      <main className="mx-auto flex w-screen flex-col items-center bg-slate-800 lg:max-w-4xl md:max-w-2xl">
        ...
        <div className="flex min-h-screen flex-col justify-center">
          ...
          {data?.map((post) => (
            <div key={post.id} className="mb-2 rounded-md border-4 bg-slate-400 p-4 text-center text-3xl">
              {post.content}
            </div>
          ))}
        </div>
